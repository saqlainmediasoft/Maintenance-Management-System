...
<table width="95%" border="0" cellspacing="0" cellpadding="0"  align="center" style="margin-top:10px;">
  <tr>
    <td style="color:#009900; font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif;"><h4><a href="welcome.php"> HOME</a> &nbsp;<i class="icon-chevron-left" style="vertical-align:middle; padding-bottom:5px;"></i> &nbsp; JUNCTION PICTURES</h4>
    </td>
  </tr>
</table>    
  ...
  <tr>
        ...
        <div class="scrollWrapper">
         <table width="100%" border="0" cellspacing="4" cellpadding="4" style="border-color:#DCDCDC;" class="table table-bordered" height="100"> 
           <?php
			...
			?>
            <tr style="font-size:12px; font-weight:bold; cursor:pointer;" id="junc_id" class="foo" onClick="document.getElementById('iframeID').src='junction-picture-view.php?junc_id=<?php echo $junc_id; ?>'; return false;">
    ...
    <td width="70%" valign="top">
        <table width="100%" border="0" cellspacing="4" cellpadding="4" style="border-color:#DCDCDC;" class="table table-bordered">
          <tr>
            <td>
            	<iframe width="100%" height="575" scrolling="yes" src="junction-picture-view.php" style="overflow:scroll;" frameborder="0" id="iframeID"></iframe>
            </td>  
          </tr>
        </table>
    </td>
